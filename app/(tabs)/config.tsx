import { StyleSheet, Platform, ScrollView, useWindowDimensions, Animated, Image } from 'react-native';
          ...
          <ThemedView style={[
            ...
            <PageContainer>
              <ThemedView style={styles.loremContainer}>
                <Image 
                  source={{ uri: 'https://www.pontotel.com.br/local/wp-content/uploads/2022/05/imagem-corporativa.webp' }}
